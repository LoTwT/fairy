...
export interface CrawlTask {
  ...
  extract: ($: cheerio.CheerioAPI, html: string) => unknown | Promise<unknown>
}
...
export async function fetchDynamic(url: string): Promise<string> {
 ...
 */
export function decodeSvelteKitData(data: unknown[]): unknown {
