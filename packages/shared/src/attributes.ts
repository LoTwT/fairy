import type { CoreSkillLevel, DamageElement, StatUnitMap } from "./effects.ts"

/** 计算单位；百分比使用比例，所有字段均已脱离来源显示缩放。 */
export type PanelAttributeUnitMap = Pick<
  StatUnitMap,
  | "health"
  | "attack"
  | "defense"
...
export type PanelCoreSkillLevel = CoreSkillLevel
export type DriveDiscSlot = 1 | 2 | 3 | 4 | 5 | 6
export type DriveDiscDamageElement = Extract<
  DamageElement,
