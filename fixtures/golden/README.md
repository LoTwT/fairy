...
- `golden-cases.json`: the 23 historical golden anchors from Product v2.0 /
  QA-1 v0.2, mapped to TL-3 schema paths and required trace evidence. The V1
  true-data replay gate is currently narrowed to 19 anchors; G13/G18/G19/G20
  are tracked as V1.x deferred in `docs/qa/golden-source-coverage.md`.
- `data/cleaned/golden/v1-replay-report.json`: the current source-backed replay
  baseline for the 19-anchor V1 scope. It is generated by
