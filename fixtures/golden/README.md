...
- `golden-cases.json`: the 23 historical golden anchors from Product v2.0 /
  QA-1 v0.2 plus the V1.1 Bangboo anchors G24-G25, mapped to schema paths and
  required trace evidence. G13/G18/G19/G20/G24/G25 are now executable true-data
  replay anchors.
- `data/cleaned/golden/v1-replay-report.json`: the current source-backed replay
  baseline for the 25-anchor V1/V1.1 scope. It is generated by
