...
当前已实现 Agents、Drive Discs 与 W-Engines，并已落地 v2 清单、实体注册表、组合 staging、定向重跑、历史实体集合 epoch 和分层验证。其余实体和 End Game 子域尚未完成正式设计、实现或全量验证。轻量调研、共享设计决策及当前实施队列见 [Nanoka 后续实体实施计划](../../plans/nanoka-entities.md)。
