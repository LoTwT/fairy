...
13. `V13` anomaly/disorder curated coverage：已完成 scope freeze；下一步按批次减少异常 / 紊乱路径中的 `coverage-gap diagnostics`，优先补 `格莉丝`、`简`、`柳`、`派派`、`柏妮思`、`爱丽丝`、`爱芮` 及对应音擎，见 [静态构筑解析系统 V13](./static-build-resolver-v13.md)
