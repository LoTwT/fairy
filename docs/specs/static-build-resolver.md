...
13. `V13` anomaly/disorder curated coverage：已完成 scope freeze 与 inventory；当前已把 `格莉丝`、`简`、`柳`、`派派`、`柏妮思`、`爱丽丝`、`爱芮` 及对应音擎按 Batch A / Batch B 固定下来，下一步进入 Batch A 实现，见 [静态构筑解析系统 V13](./static-build-resolver-v13.md)
