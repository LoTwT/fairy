...
17. `V17` generic drive-disc curated coverage：当前已完成 `V17.1` scope freeze，目标是在不新增 team snapshot / teammate loadout contract 的前提下，把当前 static resolver 能稳定表达的通用驱动盘补成 curated coverage，见 [静态构筑解析系统 V17](./static-build-resolver-v17.md)
