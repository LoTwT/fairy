...
44. `V44` source-entry collection aggregates：当前阶段已冻结范围；下一步只为 unified source-entry collection 的 `summary` 补聚合 `diagnosticSummary / sourceNoteSummary`，不改现有 `entries[]` 与单条 entry summary，见 [静态构筑解析系统 V44](./static-build-resolver-v44.md)
