...
15. `V15` structured source-note guidance：已完成 `V15.3` adoption；当前 `sourceNotes.guidance` 已进入公开 contract，`zzz-agent` prompt 与 README 已优先消费该结构化 guidance，见 [静态构筑解析系统 V15](./static-build-resolver-v15.md)
