...
16. `V16` generic w-engine curated coverage：已完成 `V16.2` inventory；当前已冻结 Batch A / Batch B / Batch C，下一步按批次补齐通用音擎 curated coverage，减少 specialty-compatible 构筑下的 generic assumptions，见 [静态构筑解析系统 V16](./static-build-resolver-v16.md)
