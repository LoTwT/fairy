...
38. `V38` source-view compact helpers：目标是把 `source-damage-view / source-utility-view` 也收口为与 `V37` 对称的 compact helper exports，并让高层 source-view tool 对齐 `includeDetails` 语义，见 [静态构筑解析系统 V38](./static-build-resolver-v38.md)
