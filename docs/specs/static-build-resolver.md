...
43. `V43` utility-entry summaries：当前阶段已冻结范围；下一步只为 `source-utility-view entry` 补稳定 `diagnosticSummary / sourceNoteSummary`，不改现有 `diagnostics[] / sourceNotes[]`，见 [静态构筑解析系统 V43](./static-build-resolver-v43.md)
