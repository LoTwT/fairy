...
9. `V9` source-specific damage view：已完成 `V9.3` first-batch source coverage；`爱丽丝 [极性强击]`、`雅 [霜灼·破]`、`柏妮思 [余烬]` 已通过独立静态 view 暴露，而不继续并入主 anomaly / disorder 公式，见 [静态构筑解析系统 V9](./static-build-resolver-v9.md)
