...
15. `V15` structured source-note guidance：已完成 scope freeze；下一步把 `sourceNotes` 的“下一步该怎么做”提升成结构化 guidance，减少 Agent / UI 对中文 note 文案的依赖，见 [静态构筑解析系统 V15](./static-build-resolver-v15.md)
