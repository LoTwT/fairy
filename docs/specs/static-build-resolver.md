...
299. `V299` build effect-summary text contracts：当前阶段进行中；当前目标是为 effect-summary 公开 contract 中的 `bucket / value / condition` 补显式公开 type，并统一复用，不改变任何运行时行为，见 [静态构筑解析系统 V299](./static-build-resolver-v299.md)
