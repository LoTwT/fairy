...
- [`static-build-resolver-roadmap.md`](../docs/specs/static-build-resolver-roadmap.md) — 执行路线与阶段状态：当前主线已推进到 `V27`；已覆盖 source views、trigger matrix、utility views 与 unified source-entry collection，下一阶段聚焦 trigger-entry matrix summary
...
- [`static-build-resolver-v27.md`](../docs/specs/static-build-resolver-v27.md) — 当前阶段：已完成 scope freeze；目标是为 trigger-entry matrix 增加稳定 `summary`，并固定 `main-formula / source-view` 的分组与排序语义
