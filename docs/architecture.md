...
- [`static-build-resolver-v5.md`](../docs/specs/static-build-resolver-v5.md) — 当前阶段范围：`V5.3` 第一批来源覆盖已完成，`柏妮思` / `爱芮` 的 `dynamicSnapshot` 已进入 anomaly/disorder resolver；下一步细化 source-specific assumptions
