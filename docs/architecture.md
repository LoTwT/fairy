...
- [`static-build-resolver-v22.md`](../docs/specs/static-build-resolver-v22.md) — 当前阶段范围：为 source damage view / source utility view 增加稳定 metadata；对齐 `canonicalLabel / stableKey / entryKind`
