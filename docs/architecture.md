...
- [`static-build-resolver-v13.md`](../docs/specs/static-build-resolver-v13.md) — 当前阶段范围：已完成 scope freeze；下一步按批次补 anomaly / disorder 的高频 curated coverage，减少剩余 `coverage-gap diagnostics`
