...
- [`static-build-resolver-v8.md`](../docs/specs/static-build-resolver-v8.md) — 当前阶段范围：`V8.1` contract freeze 已完成；下一步盘点 anomaly / disorder 剩余 assumptions 的 contract 归属，并只在存在明确共性时新增最小 contract
