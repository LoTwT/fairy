...
- [`static-build-resolver-roadmap.md`](../docs/specs/static-build-resolver-roadmap.md) — 执行路线与阶段状态：当前主线已推进到 `V32`；已覆盖 source views、trigger matrix、utility views、unified source-entry collection、main resolver summary、core skill matrix summary 与 core skill matrix effect summary，当前正在冻结 source-entry summary alignment
...
- [`static-build-resolver-v32.md`](../docs/specs/static-build-resolver-v32.md) — 当前阶段：已冻结 source-entry summary alignment；目标是去掉 `resolve-build-source-entries` 对 `collection.summary` 的最后一处高层 aliasing
