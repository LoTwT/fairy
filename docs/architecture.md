...
- [`static-build-resolver-roadmap.md`](../docs/specs/static-build-resolver-roadmap.md) — 执行路线与阶段状态：当前主线已推进到 `V33`；已覆盖 source views、trigger matrix、utility views、unified source-entry collection、main resolver summary、core skill matrix summary 与 core skill matrix effect summary，当前正在冻结 support-scope normalization
...
- [`static-build-resolver-v33.md`](../docs/specs/static-build-resolver-v33.md) — 当前阶段：已冻结 support-scope normalization；目标是统一 `resolve-build-*` 高层 tool 的 unsupported / support-scope 组装与 catalog helper
