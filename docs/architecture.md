...
- [`static-build-resolver-v43.md`](../docs/specs/static-build-resolver-v43.md) — 当前阶段：已冻结范围；下一步只为 `source-utility-view entry` 补稳定 `diagnosticSummary / sourceNoteSummary`
