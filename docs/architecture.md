...
- [`static-build-resolver-v6.md`](../docs/specs/static-build-resolver-v6.md) — 当前阶段范围：`V6.2` state snapshot resolver 已完成基础接线；下一步开始 `爱丽丝` / `雅` 的 source-state snapshot coverage
