...
- [`static-build-resolver-v6.md`](../docs/specs/static-build-resolver-v6.md) — 当前阶段范围：`V6.1` contract freeze 已完成；当前进入 `V6.2`，准备把 `爱丽丝` / `雅` 的 source-state snapshot 接入 resolver
