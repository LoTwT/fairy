...
- [`static-build-resolver-v12.md`](../docs/specs/static-build-resolver-v12.md) — 当前阶段范围：已完成 scope freeze；下一步补 structured diagnostics，覆盖 generic assumptions / coverage gaps / unsupported effects
