...
- [`static-build-resolver-roadmap.md`](../docs/specs/static-build-resolver-roadmap.md) — 执行路线与阶段状态：当前主线已推进到 `V26`；已覆盖 source views、trigger matrix、utility views 与 unified source-entry collection，下一阶段聚焦 collection summary
...
- [`static-build-resolver-v26.md`](../docs/specs/static-build-resolver-v26.md) — 当前阶段：已完成 scope freeze；目标是为 unified source-entry collection 增加稳定 summary、分组与排序 contract
