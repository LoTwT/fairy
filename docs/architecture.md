...
- [`static-build-resolver-v5.md`](../docs/specs/static-build-resolver-v5.md) — 当前阶段范围：`V5.1` contract freeze 已完成，已冻结 `dynamicSnapshot` 输入与 tool schema；下一步为 resolver runtime 接线
