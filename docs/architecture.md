...
- [`static-build-resolver-v18.md`](../docs/specs/static-build-resolver-v18.md) — 当前阶段范围：已完成 scope freeze 与 inventory；最后一批 legacy 强攻签名将按当前 contract 做 partial coverage + source-note 收口
