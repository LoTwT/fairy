...
- [`static-build-resolver-roadmap.md`](../docs/specs/static-build-resolver-roadmap.md) — 执行路线与阶段状态：当前主线已推进到 `V214`；已覆盖 source views、trigger matrix、utility views、unified source-entry collection、main resolver summary、core skill matrix summary、core skill matrix effect summary、matrix row damage summary、matrix row compact fields、matrix row explanation fields，以及 matrix / trigger / source-entry / source-view / single-build compact helper exports；在 `V156 explicit compact summary contracts`、`V157 explicit compact row/entry summaries`、`V158 explicit compact skill-matrix summaries`、`V159 explicit compact group summaries`、`V160 explicit compact top-level summaries`、`V161 explicit compact aggregate summaries`、`V162 explicit compact row and entry aggregate summaries`、`V163 explicit compact top-level summary aggregate summaries`、`V164 explicit compact group aggregate summaries`、`V165 explicit compact result-level requirement summaries`、`V166 explicit compact top-level summary requirement summaries`、`V167 explicit compact group requirement summaries`、`V168 explicit compact row requirement summaries`、`V169 explicit compact entry requirement summaries`、`V170 explicit compact result-level effect summaries`、`V171 explicit compact top-level summary effect summaries`、`V172 explicit compact group effect summaries`、`V173 explicit compact row and entry effect summaries`、`V174 explicit compact summary group items`、`V175 explicit compact diagnostic/source-note detail entries`、`V176 explicit compact requirement detail entries`、`V177 explicit compact single-build trace items`、`V178 explicit compact resolved buckets`、`V179 explicit compact resolved panel`、`V180 explicit compact damage params`、`V181 explicit compact damage results`、`V182 explicit compact loadout`、`V183 explicit compact single-build header`、`V184 explicit compact matrix result headers`、`V185 explicit compact source-view result headers`、`V186 explicit compact source-view entry metadata`、`V187 explicit compact skill-matrix row metadata`、`V188 explicit compact trigger row metadata`、`V189 explicit compact entry damage summaries`、`V190 explicit compact nested build details`、`V191 explicit compact source utility view contracts`、`V192 explicit compact source damage view contracts`、`V193 explicit compact trigger row metadata sources`、`V194 explicit compact skill row metadata sources`、`V195 explicit compact detail source types`、`V196 explicit compact base damage stat summaries`、`V197 explicit compact profile and loadout traits`、`V198 explicit compact trace status`、`V199 explicit compact skill row tag and attribute`、`V200 explicit build source types`、`V201 explicit build base damage stat types`、`V202 explicit source-damage resolution mode types`、`V203 explicit build specialty type`、`V204 explicit compact helper input contracts`、`V205 build-tool unsupported scope alignment`、`V206 source-entry coverage-gap helper contracts`、`V207 build-tool success response contracts`、`V208 source-entry tool typed panel normalization`、`V209 build-tool loadout helper contracts`、`V210 build-tool catalog helper contracts`、`V211 build-tool scenario helper contracts`、`V212 build-tool damage-type helper contracts`、`V213 build-tool utility support helper contracts` 基础上，6 个高层 build tool 的 progression-aware `loadout` 组装也已统一收进 shared helper
