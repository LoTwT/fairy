...
- [静态构筑解析系统 V50](./specs/static-build-resolver-v50.md) — 当前阶段：已完成 scope freeze；目标是为 `source-damage-view entry` 增加稳定 `summary`
