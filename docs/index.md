...
- [静态构筑解析系统 V8](./specs/static-build-resolver-v8.md) — 当前阶段：已完成 `V8.1` contract freeze、`V8.2` 第一批 inventory 与 `V8.4` 第一批 source-note 收口；当前结论是不新增 public key，先继续按 contract 归属收紧 assumptions
