...
- [静态构筑解析系统路线图](./specs/static-build-resolver-roadmap.md) — 当前执行状态：已推进到 V26；当前 contract 已覆盖 source views、trigger matrix、utility views 与 unified source-entry collection，下一阶段聚焦 source-entry collection summary
...
- [静态构筑解析系统 V26](./specs/static-build-resolver-v26.md) — 当前阶段：已完成 scope freeze；目标是为 unified source-entry collection 增加稳定 summary、分组与排序 contract
