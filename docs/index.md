...
- [静态构筑解析系统 V5](./specs/static-build-resolver-v5.md) — 当前阶段：`V5.3` 第一批来源覆盖已完成，`柏妮思` / `爱芮` 的 `dynamicSnapshot` 已进入 anomaly/disorder resolver；下一步细化 source-specific assumptions
