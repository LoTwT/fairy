...
- [静态构筑解析系统 V42](./specs/static-build-resolver-v42.md) — 当前阶段：已冻结范围；下一步只为 source-view / trigger-row 补结构化 `sourceNoteSummary`，不改 `sourceNotes[]`
