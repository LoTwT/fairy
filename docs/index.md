...
- [静态构筑解析系统 V44](./specs/static-build-resolver-v44.md) — 当前阶段：已冻结范围；下一步只为 unified source-entry collection 的 `summary` 补聚合 `diagnosticSummary / sourceNoteSummary`
