...
- user-facing AI copy in any fixture does not contain skill names
  (`fairy-vision`, `fairy-snapshot`, `fairy-calc`, `fairy-explain`),
  internal orchestration phrasing (`invoking ...`, `transferring to ...`,
  `handing off to ...`), or other chain-implementation language; static scan or
  human review on fixture text validates this;
...
- user-facing calc/result copy does not contain skill names
  (`fairy-vision`, `fairy-snapshot`, `fairy-calc`, `fairy-explain`),
  internal orchestration phrasing (`invoking ...`, `transferring to ...`,
  `handing off to ...`), or other chain-implementation language; static scan or
  human review on fixture text validates this;
